    ...
    <BrowserRouter>
      <AppRotes>
        <Route path='/' element={<MainLayout />}>
          <Route path='lagerverwaltung' element={<Page id="lagerverwaltung" heading="Lagerverwaltung" />} />
          ...
          <Route path='administration' element={<Page id='administration' heading="Administration" />} />
          ...
          <Route path='auswahllisten' element={<Page id='auswahllisten' heading="Auswahllisten" />} />
